...
const Body = () => {
  ...
  const [paragraphs, setParagraphs] = useState([
    "Tech for Better Crops on Your Farm",
    "Enhance Your Farming with Tech",
    "Creating Tech Solutions for Farming",
  ]);
  ...
  const divStyle = {
    fontSize: "clamp(2rem, 13vw, 8rem)", // Adjust the font size as needed
    padding: "20px",
  };
