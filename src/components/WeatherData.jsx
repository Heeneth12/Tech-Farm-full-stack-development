...
function WeatherData() {
  ...
  return (
    <div
      className="lg:w-1/2 sm:w-1/2  relative mx-auto bg-blue-100 p-8 rounded-lg shadow-md item-center "
      style={{
        height: "50vh",
      }}
    >
      ...
      <div id="temperatureChartContainer" className="mt-4 h-44">
        <canvas
      ...
      <div id="rainPredictionChartContainer" className="mt-4 h-44">
        <canvas
